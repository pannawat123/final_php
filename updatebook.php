    ...
    <form enctype="multipart/form-data" name="save" method="post" action="saveupdatebook.php">
        ...
        <table width="650" border="1" bgcolor="#FFFFFF" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="filUpload" value="<?php echo $data['Picture']; ?>">
                    <?php echo "<a href=\"deletepicture.php?id=$id\">ลบรูปภาพ "; ?>
                    <?php echo "<img src=\"uploads/" . $data['Picture'] . "\" width=\"300\" height=\"300\">"; ?>
                </td>
